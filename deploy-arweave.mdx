...
[Arweave Name System (ArNS)](ar.io/arns).
...
[Progressive Centralization](https://www.youtube.com/watch?v=ZkL5xuNVAS4), your
...
Turbo has a [friendly topup page](https://turbo-topup.com/). Head to this page,
...
or [ARIO tokens](ar.io/token). ArNS names can be leased or bought permanently.
...
```bash
DEPLOY_KEY=0xsomehash bun run deploy:arweave
```
