...
description: "IwstETHETHOracle: Interface for wstETH/ETH Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IwstETHETHOracle
- **path**: `oracles/chainlink/IwstETHETHOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, wsteth, eth
- **title**: IwstETHETHOracle
