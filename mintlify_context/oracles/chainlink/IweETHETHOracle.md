...
description: "IweETHETHOracle: Interface for weETH/ETH Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IweETHETHOracle
- **path**: `oracles/chainlink/IweETHETHOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, weeth, eth
- **title**: IweETHETHOracle
