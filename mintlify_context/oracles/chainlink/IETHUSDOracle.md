---
title: "IETHUSDOracle"
description: "IETHUSDOracle: Interface for ETH/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IETHUSDOracle
- **path**: `oracles/chainlink/IETHUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, eth, usd
- **title**: IETHUSDOracle
