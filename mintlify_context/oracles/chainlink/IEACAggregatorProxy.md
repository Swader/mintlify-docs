...
description: "IEACAggregatorProxy: Base interface for Chainlink EAC Aggregator Proxy contracts (Extended interface for Chainlink price feed proxies)"
---

### Overview

- **name**: IEACAggregatorProxy
- **path**: `oracles/chainlink/IEACAggregatorProxy.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, proxy
- **title**: IEACAggregatorProxy
