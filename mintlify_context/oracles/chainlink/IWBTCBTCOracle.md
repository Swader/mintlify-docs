...
description: "IWBTCBTCOracle: Interface for WBTC/BTC Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IWBTCBTCOracle
- **path**: `oracles/chainlink/IWBTCBTCOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, wbtc, btc
- **title**: IWBTCBTCOracle
