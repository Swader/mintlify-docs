---
title: "IPOLUSDOracle"
description: "IPOLUSDOracle: Interface for POL/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IPOLUSDOracle
- **path**: `oracles/chainlink/IPOLUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, pol, usd
- **title**: IPOLUSDOracle
