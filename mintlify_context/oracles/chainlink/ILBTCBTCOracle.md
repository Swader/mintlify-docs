...
description: "ILBTCBTCOracle: Interface for LBTC/BTC Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: ILBTCBTCOracle
- **path**: `oracles/chainlink/ILBTCBTCOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, lbtc, btc
- **title**: ILBTCBTCOracle
