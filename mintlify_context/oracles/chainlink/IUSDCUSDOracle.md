...
description: "IUSDCUSDOracle: Interface for USDC/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IUSDCUSDOracle
- **path**: `oracles/chainlink/IUSDCUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, usdc, usd
- **title**: IUSDCUSDOracle
