...
description: "IJitoSOLUSDOracle: Interface for jitoSOL/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IJitoSOLUSDOracle
- **path**: `oracles/chainlink/IJitoSOLUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, jitosol, usd
- **title**: IJitoSOLUSDOracle
