---
title: "IYFIUSDOracle"
description: "IYFIUSDOracle: Interface for YFI/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IYFIUSDOracle
- **path**: `oracles/chainlink/IYFIUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, yfi, usd
- **title**: IYFIUSDOracle
