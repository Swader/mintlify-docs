---
title: "ISOLUSDOracle"
description: "ISOLUSDOracle: Interface for SOL/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: ISOLUSDOracle
- **path**: `oracles/chainlink/ISOLUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, sol, usd
- **title**: ISOLUSDOracle
