...
description: "IJitoSOLSOLOracle: Interface for jitoSOL/SOL Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IJitoSOLSOLOracle
- **path**: `oracles/chainlink/IJitoSOLSOLOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, jitosol, sol
- **title**: IJitoSOLSOLOracle
