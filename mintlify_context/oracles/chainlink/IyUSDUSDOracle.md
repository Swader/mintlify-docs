...
description: "IyUSDUSDOracle: Interface for yUSD/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IyUSDUSDOracle
- **path**: `oracles/chainlink/IyUSDUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, yusd, usd
- **title**: IyUSDUSDOracle
