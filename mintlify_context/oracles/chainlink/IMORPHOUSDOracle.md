...
description: "IMORPHOUSDOracle: Interface for MORPHO/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: IMORPHOUSDOracle
- **path**: `oracles/chainlink/IMORPHOUSDOracle.sol`
- **context**: morpho
- **tags**: oracle, chainlink, price-feed, morpho, usd
- **title**: IMORPHOUSDOracle
