...
description: "ILINKUSDOracle: Interface for LINK/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: ILINKUSDOracle
- **path**: `oracles/chainlink/ILINKUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, link, usd
- **title**: ILINKUSDOracle
