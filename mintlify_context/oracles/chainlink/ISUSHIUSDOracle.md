...
description: "ISUSHIUSDOracle: Interface for SUSHI/USD Chainlink price oracle on Katana (Extends the EAC Aggregator Proxy interface for price feeds)"
---

### Overview

- **name**: ISUSHIUSDOracle
- **path**: `oracles/chainlink/ISUSHIUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, chainlink, price-feed, sushi, usd
- **title**: ISUSHIUSDOracle
