---
title: "IBTCUSDOracle"
description: "IBTCUSDOracle: Interface for BTC/USD RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IBTCUSDOracle
- **path**: `oracles/redstone/IBTCUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, btc, usd
- **title**: IBTCUSDOracle
