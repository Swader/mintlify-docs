...
description: "IRedstoneAggregator: Base interface for RedStone price oracle aggregators (Interface for RedStone price feed contracts)"
---

### Overview

- **name**: IRedstoneAggregator
- **path**: `oracles/redstone/IRedstoneAggregator.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, aggregator
- **title**: IRedstoneAggregator
