...
description: "IweETHETHOracle: Interface for weETH/ETH RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IweETHETHOracle
- **path**: `oracles/redstone/IweETHETHOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, weeth, eth
- **title**: IweETHETHOracle
