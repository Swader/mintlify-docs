...
description: "IAUSDUSDOracle: Interface for AUSD/USD RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IAUSDUSDOracle
- **path**: `oracles/redstone/IAUSDUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, ausd, usd
- **title**: IAUSDUSDOracle
