...
description: "IWBTCUSDOracle: Interface for WBTC/USD RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IWBTCUSDOracle
- **path**: `oracles/redstone/IWBTCUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, wbtc, usd
- **title**: IWBTCUSDOracle
