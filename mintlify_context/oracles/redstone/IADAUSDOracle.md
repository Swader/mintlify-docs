---
title: "IADAUSDOracle"
description: "IADAUSDOracle: Interface for ADA/USD RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IADAUSDOracle
- **path**: `oracles/redstone/IADAUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, ada, usd
- **title**: IADAUSDOracle
