---
title: "IETHUSDOracle"
description: "IETHUSDOracle: Interface for ETH/USD RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IETHUSDOracle
- **path**: `oracles/redstone/IETHUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, eth, usd
- **title**: IETHUSDOracle
