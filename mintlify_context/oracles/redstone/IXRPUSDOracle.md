---
title: "IXRPUSDOracle"
description: "IXRPUSDOracle: Interface for XRP/USD RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IXRPUSDOracle
- **path**: `oracles/redstone/IXRPUSDOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, xrp, usd
- **title**: IXRPUSDOracle
