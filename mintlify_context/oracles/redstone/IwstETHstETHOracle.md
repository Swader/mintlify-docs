...
description: "IwstETHstETHOracle: Interface for wstETH/stETH RedStone price oracle on Katana (Extends the RedStone Aggregator interface for price feeds)"
---

### Overview

- **name**: IwstETHstETHOracle
- **path**: `oracles/redstone/IwstETHstETHOracle.sol`
- **context**: oracle
- **tags**: oracle, redstone, price-feed, wsteth, steth
- **title**: IwstETHstETHOracle
