...
description: "INativeConverter: Base interface for Native Converter contracts (Converts between native and bridged vault tokens)"
---

### Overview

- **name**: INativeConverter
- **path**: `vb/INativeConverter.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, converter, bridge, native
- **title**: INativeConverter
