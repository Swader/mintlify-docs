...
description: "IWBTCNativeConverter: Interface for the WBTC Native Converter (Converts between WBTC and its bridged representation across networks)"
---

### Overview

- **name**: IWBTCNativeConverter
- **path**: `vb/converters/IWBTCNativeConverter.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, converter, wbtc, native
- **title**: IWBTCNativeConverter
