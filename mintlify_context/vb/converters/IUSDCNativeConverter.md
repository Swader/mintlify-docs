...
description: "IUSDCNativeConverter: Interface for the USDC Native Converter (Converts between USDC and its bridged representation across networks)"
---

### Overview

- **name**: IUSDCNativeConverter
- **path**: `vb/converters/IUSDCNativeConverter.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, converter, usdc, native
- **title**: IUSDCNativeConverter
