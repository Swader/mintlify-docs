---
title: "IbvbEth"
description: "IbvbEth: Interface for the Bridged Vault Bridge ETH token. This is deployed on
   ...
   context is different, and indicated in custom tags. (Bridged Vault Bridge token that allows bridging ETH across networks with yield exposure)"
---

### Overview

- **name**: IbvbEth
- **path**: `vb/tokens/IbvbEth.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, token, eth, bridge, destination
- **title**: IbvbEth
