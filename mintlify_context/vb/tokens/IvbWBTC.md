---
title: "IvbWBTC"
description: "IvbWBTC: Interface for the Vault Bridge WBTC token. This is deployed on the
   ...
   in custom tags. (Vault Bridge token that allows bridging WBTC across networks with yield exposure)"
---

### Overview

- **name**: IvbWBTC
- **path**: `vb/tokens/IvbWBTC.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, token, wbtc, yield, origin
- **title**: IvbWBTC
