---
title: "IvbUSDC"
description: "IvbUSDC: Interface for the Vault Bridge USDC token. This is deployed on the
   ...
   in custom tags. (Vault Bridge token that allows bridging USDC across networks with yield exposure)"
---

### Overview

- **name**: IvbUSDC
- **path**: `vb/tokens/IvbUSDC.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, token, usdc, yield, origin
- **title**: IvbUSDC
