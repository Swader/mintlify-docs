---
title: "IvbETH"
description: "IvbETH: Interface for the Vault Bridge ETH token. This is deployed on the
   ...
   in custom tags. (Vault Bridge token that allows bridging ETH across networks with yield exposure)"
---

### Overview

- **name**: IvbETH
- **path**: `vb/tokens/IvbETH.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, token, eth, yield, origin
- **title**: IvbETH
