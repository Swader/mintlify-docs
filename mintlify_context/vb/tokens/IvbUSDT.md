---
title: "IvbUSDT"
description: "IvbUSDT: Interface for the Vault Bridge USDT token. This is deployed on the
   ...
   in custom tags. (Vault Bridge token that allows bridging USDT across networks with yield exposure)"
---

### Overview

- **name**: IvbUSDT
- **path**: `vb/tokens/IvbUSDT.sol`
- **context**: vaultbridge
- **tags**: vaultbridge, token, usdt, yield, origin
- **title**: IvbUSDT
...
- **tatara**: sepolia (tatara) – [`0xb3f50565f611D645e0DDB44eB09c4588B1601514`](https://sepolia.etherscan.io/address/0xb3f50565f611D645e0DDB44eB09c4588B1601514)
- **katana**: ethereum (katana) – [`0x6d4f9f9f8f0155509ecd6Ac6c544fF27999845CC`](https://etherscan.io/address/0x6d4f9f9f8f0155509ecd6Ac6c544fF27999845CC)
- **bokuto**: sepolia (bokuto) – [`0xdd9aCdD3D2AeC1C823C51f8389597C6be9779B28`](https://sepolia.etherscan.io/address/0xdd9aCdD3D2AeC1C823C51f8389597C6be9779B28)
...
backingDifference()
balanceOf(address)
claimAndRedeem(bytes32[32],bytes32[32],uint256,bytes32,bytes32,address,uint256,address,bytes)
convertToAssets(uint256)
convertToShares(uint256)
decimals()
deposit(uint256,address)
depositAndBridge(uint256,address,uint32,bool)
depositGasToken(address)
depositGasTokenAndBridge(address,uint32,bool)
depositWithPermit(uint256,address,bytes)
depositWithPermitAndBridge(uint256,address,uint32,bool,bytes)
eip712Domain()
...
mintWithGasToken(uint256,address)
name()
nonces(address)
paused()
performReversibleYieldVaultDeposit(uint256)
