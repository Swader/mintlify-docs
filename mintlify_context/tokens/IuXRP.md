---
title: "IuXRP"
description: "IuXRP: Interface for Universal XRP (uXRP), the Universal wrapped XRP on Katana (uXRP implements the standard ERC-20 interface)"
---

### Overview

- **name**: IuXRP
- **path**: `tokens/IuXRP.sol`
- **context**: erc20
- **tags**: erc20, token, wrapped, xrp, uxrp
- **title**: IuXRP
