---
title: "IPOL"
description: "IPOL: Interface for Bridge-wrapped POL (POL) on Katana (POL implements the standard ERC-20 interface)"
---

### Overview

- **name**: IPOL
- **path**: `tokens/IPOL.sol`
- **context**: erc20
- **tags**: erc20, token, governance, polygon, pol
- **title**: IPOL
