---
title: "IYFI"
description: "IYFI: Interface for Bridge-wrapped Yearn Finance (YFI) on Katana (YFI implements the standard ERC-20 interface)"
---

### Overview

- **name**: IYFI
- **path**: `tokens/IYFI.sol`
- **context**: yearn
- **tags**: erc20, token, governance, yearn, yfi
- **title**: IYFI
