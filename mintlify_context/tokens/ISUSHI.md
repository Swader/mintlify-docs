---
title: "ISUSHI"
description: "ISUSHI: Interface for Bridge-wrapped SUSHI (SUSHI) on Katana (SUSHI implements the standard ERC-20 interface)"
---

### Overview

- **name**: ISUSHI
- **path**: `tokens/ISUSHI.sol`
- **context**: erc20
- **tags**: erc20, token, governance, sushi, defi
- **title**: ISUSHI
