---
title: "IweETH"
description: "IweETH: Interface for Bridge-wrapped weETH (weETH) on Katana (weETH implements the standard ERC-20 interface)"
---

### Overview

- **name**: IweETH
- **path**: `tokens/IweETH.sol`
- **context**: erc20
- **tags**: erc20, token, staking, weeth, etherfi
- **title**: IweETH
