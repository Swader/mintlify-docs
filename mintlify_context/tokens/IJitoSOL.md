---
title: "IJitoSOL"
description: "IJitoSOL: Interface for Jito Staked SOL (JitoSOL) on Katana (JitoSOL implements the standard ERC-20 interface)"
---

### Overview

- **name**: IJitoSOL
- **path**: `tokens/IJitoSOL.sol`
- **context**: erc20
- **tags**: erc20, token, staking, jitosol, solana
- **title**: IJitoSOL
