---
title: "IKAT"
description: "IKAT: Interface for KAT, the native token on Katana (KAT implements the standard ERC-20 interface)"
---

### Overview

- **name**: IKAT
- **path**: `tokens/IKAT.sol`
- **context**: erc20
- **tags**: erc20, token, governance, katana, native
- **title**: IKAT
