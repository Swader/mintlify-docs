---
title: "IBTCK"
description: "IBTCK: Interface for Bitcoin on Katana (BTCK) on Katana (BTCK implements the standard ERC-20 interface)"
---

### Overview

- **name**: IBTCK
- **path**: `tokens/IBTCK.sol`
- **context**: erc20
- **tags**: erc20, token, bitcoin, btck
- **title**: IBTCK
