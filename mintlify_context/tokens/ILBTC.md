---
title: "ILBTC"
description: "ILBTC: Interface for Lombard Staked BTC (LBTC) on Katana (LBTC implements the standard ERC-20 interface)"
---

### Overview

- **name**: ILBTC
- **path**: `tokens/ILBTC.sol`
- **context**: erc20
- **tags**: erc20, token, bitcoin, lbtc, liquid
- **title**: ILBTC
