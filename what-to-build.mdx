---
title: "What to Build"
description: "Concrete build ideas for Katana hackathons mapped to named Katana primitives and optional Agglayer angles"
---

## UX & Wallet
1) Gasless WebAuthn Smart Wallet
- Primitives: ERC-4337 (EntryPoint v0.6/v0.7), RIP-7212 (R1), Permit2, Bundler3
...
- Primitives: AUSD, SushiSwap v3, Morpho Blue, MetaMorpho, Multicall3, Oracles (Chainlink/RedStone)
...
- Primitives: ERC-4337, Permit2, Gnosis Safe, MultiSendCallOnly
...
- Primitives: Agglayer Bridge, Native Converters (WETH/USDC/USDT/WBTC), AUSD
...
- Primitives: Bundler3, Permit2, SushiSwap v3, Morpho Blue, MetaMorpho
...
- Primitives: Seaport, Conduit, Catalog/Render utils, Bulk Writer
...
- Primitives: ERC-4337, Oracles (Chainlink/RedStone), Bundler3, CreateX
...
- Primitives: Gnosis Safe, MultiSend, Yearn, MetaMorpho
...
- Primitives: SushiSwap v3, Oracles, (Optional) Perps venue, Bundler3
...
- Primitives: Morpho Blue, Oracles, AUSD
...
- Primitives: AUSD, MetaMorpho, Yearn, Oracles
...
- Primitives: (Optional) Perps venue, Oracles, Morpho Blue
...
- Primitives: AUSD, Permit2, ERC-4337
...
- Primitives: bvbETH/bvbUSDC, vbETH/vbUSDC, ERC-4337, RIP-7212
...
- Primitives: Oracles, AUSD, SushiSwap v3, Morpho Blue, MetaMorpho/Yearn, Bundler3
...
- Primitives: Oracles, Gnosis Safe, MultiSendCallOnly
...
- Primitives: Bundler3, CreateX, SushiSwap v3, (Optional) Perps
...
- Primitives: Agglayer Bridge, SushiSwap v3, (Optional) Perps, Oracles, Converters
...
- Primitives: AUSD, Agglayer Bridge, Permit2
...
- Primitives: vbETH/vbUSDC vaults, bvbETH/bvbUSDC on Katana, Yearn/MetaMorpho
...
- Primitives: CreateX, DeterministicDeploymentProxy, Bundler3
...
- Primitives: Chainlink, RedStone, MultiSendCallOnly
...
- Primitives: utils/addresses, Multicall3
